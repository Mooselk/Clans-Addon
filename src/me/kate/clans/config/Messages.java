...
public class Messages 
{
	...
	SPAWNER_BREAK_RAIDED, SPAWNER_BREAK_MAX, SPAWNER_BROKEN, CORE_BREAK_OWN,
	SIGN_BREAK_NO_PERMISSION, SIGN_BREAK_NO_PLAYER_PERMISSION, CHEST_NO_PERMISSION,
	CHEST_OPEN_RAID;
	...
	public void load()
	{
		...
		CORE_BREAK_OWN = color("CORE_BREAK_OWN");
		SIGN_BREAK_NO_PERMISSION = color("SIGN_BREAK_NO_PERMISSION");
		SIGN_BREAK_NO_PLAYER_PERMISSION = color("SIGN_BREAK_NO_PLAYER_PERMISSION");
		CHEST_NO_PERMISSION = color("CHEST_NO_PERMISSION");
		CHEST_OPEN_RAID = color("CHEST_OPEN_RAID");
	}
